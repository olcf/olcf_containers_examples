...
vllm serve --tensor-parallel-size 8 --pipeline-parallel-size $NNODES --distributed-executor-backend ray "/mnt/bb/$USER/$RUN_MODEL" --host 0.0.0.0 --port 8000 --gpu-memory-utilization 0.75
